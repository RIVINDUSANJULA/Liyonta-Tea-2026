...
export default function HomeContent() {
  ...
  return (
    <div className="relative w-full bg-gradient-to-br from-[#FDFCF8] via-[#e9f2e4] to-[#c9d9bf] text-[#1B3022] selection:bg-[#4F7942] selection:text-cream overflow-x-hidden font-sans">
      {/* 3D Core Layer */}
      <Experience3D />
      ...
      <section id="hero" className="relative h-screen flex flex-col items-center justify-center pointer-events-none perspective-[1000px]">
        <div className="container mx-auto px-6 text-center z-10">
          ...
          <div className="mt-8 space-y-4 max-w-2xl mx-auto opacity-80 backdrop-blur-3xl bg-white/70 p-6 rounded-full border border-[#4F7942]/30 transform translate-y-12 shadow-xl">
            <p className="text-xs md:text-sm font-bold tracking-[0.4em] uppercase text-[#4F7942]">
        ...
        <div className="absolute bottom-12 left-1/2 -translate-x-1/2 flex flex-col items-center gap-4 opacity-80">
          <span className="text-[10px] tracking-[0.3em] uppercase text-[#4F7942]">Descend</span>
          <div className="w-[1px] h-16 bg-gradient-to-b from-[#4F7942] via-[#1B3022] to-transparent" />
        </div>
      </section>
        ...
        <div className="container mx-auto px-6 z-10 w-full pointer-events-auto">
          <div className="max-w-4xl max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div 
                key={prod.id}
                className="relative group p-10 h-80 flex flex-col justify-between backdrop-blur-2xl bg-white/80 border border-[#4F7942]/20 overflow-hidden transform transition-all duration-700 hover:-translate-y-4 hover:shadow-2xl hover:bg-white"
              >
                {/* Glassmorphism Inner Shine */}
                <div className="absolute -inset-1 bg-gradient-to-b from-white/60 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-1000 blur-xl" />
                
                <span className="text-[10px] font-bold tracking-[0.5em] text-[#4F7942] transition-all">{prod.id} // ALCHEMY</span>
                
                <div>
                  <h3 className="text-2xl font-serif text-[#1B3022] mb-2">{prod.name}</h3>
      ...
      <section className="relative min-h-screen py-48 pointer-events-none flex items-center">
        <div className="relative z-10 container mx-auto px-6 text-center max-w-4xl pointer-events-auto">
          <h2 className="text-5xl md:text-7xl font-serif leading-tight mb-8">
            Where gravity ends, <span className="italic text-[#4F7942]">alchemy begins.</span>
          </h2>
          ...
          <div className="mt-20 inline-block p-[1px] bg-gradient-to-r from-transparent via-[#4F7942] to-transparent">
             <button className="px-12 py-5 bg-[#FDFCF8] text-[10px] uppercase tracking-[0.4em] font-bold text-[#1B3022] border border-[#4F7942]/30 hover:bg-[#4F7942] hover:text-white hover:shadow-lg transition-all duration-500">
               Enter The Portal
             </button>
          </div>
        </div>
